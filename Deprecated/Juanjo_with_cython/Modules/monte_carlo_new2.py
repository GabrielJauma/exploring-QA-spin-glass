...
from numba.types import void, float64, int32, int64, int8, intc, Tuple
import numpy as np
import random
import math
...
def delta_cost(dE, s, Jsparse, change):
    ...
    for c in range(copies):
        change[c] = a = random.randint(0, size-1)
...
def mc_evolution(β, J, steps=None, start=None, eq_points=1000, rng=None):
    ...
    numba_random_seed(rng.integers(0, 0xffffffff, 1, dtype=np.int64)[0])
