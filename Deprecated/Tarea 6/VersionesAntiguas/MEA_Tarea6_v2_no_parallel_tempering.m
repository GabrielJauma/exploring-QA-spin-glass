...
f = 30;                        % Nº filas matriz spins, ha de ser par.
c = 30;                        % Nº columnas "     "  , ha de ser par. 
...
N_t = n;          % A cada N_t pasos se mide M. Las medidas se usan para decidir sobre la termalización.
...
%% PARÁMETROS PARALLEL TEMPERING %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N_pt = N_durante_eq*100; % A cada N_pt se plantea un cambio de parallel tempering entre dos simulaciones a distinta T.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if modelo ==1
    Tc=(2/log(1+sqrt(2)));           % Temperatura crítica Ising, se obliga a que forme parte del barrido de temperaturas.
