function ising_2d_simulation_test ( )
...
%    John Burkardt
%
  addpath ( '../ising_2d_simulation' )

  timestamp ( );
  fprintf ( 1, '\n' );
  fprintf ( 1, 'ISING_2D_SIMULATION_TEST:\n' );
  fprintf ( 1, '  MATLAB/Octave version %s\n', version ( ) );
  fprintf ( 1, '  Test ISING_2D_SIMULATION.\n' );
